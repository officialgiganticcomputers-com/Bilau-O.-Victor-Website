...
export default function AboutMe() {
  return (
    <section id="about" className="pt-24 pb-0 bg-zinc-950 relative overflow-hidden">
      <div className="absolute inset-0 bg-grid-pattern opacity-10"></div>
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#D9FF00]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-5 fade-in-section">
            <div className="relative rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(245,158,11,0.15)] border border-[#D9FF00]/20 aspect-[3/4] md:aspect-[4/5] lg:aspect-[3/4] lg:sticky lg:top-32">
              <img 
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-[#D9FF00]/20 border border-[#D9FF00]/30 rounded-full text-[#D9FF00] text-xs font-medium backdrop-blur-sm">ICT Expert</span>
                  <span className="px-3 py-1 bg-[#D9FF00]/20 border border-[#D9FF00]/30 rounded-full text-[#D9FF00] text-xs font-medium backdrop-blur-sm">Media Systems Architect</span>
                  <span className="px-3 py-1 bg-[#D9FF00]/20 border border-[#D9FF00]/30 rounded-full text-[#D9FF00] text-xs font-medium backdrop-blur-sm">Technology Trainer</span>
                  <span className="px-3 py-1 bg-[#D9FF00]/20 border border-[#D9FF00]/30 rounded-full text-[#D9FF00] text-xs font-medium backdrop-blur-sm">Digital Strategist</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            <div className="mb-12 fade-in-section">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-white mb-4 tracking-tight">About Me</h2>
              <p className="text-[#D9FF00] font-medium tracking-wide uppercase text-sm mb-6">Bridging faith, media, leadership, and technology.</p>
              ...
              <div className="fade-in-section">
                <div className="bento-card bg-zinc-900/50 backdrop-blur-sm rounded-3xl p-8 border border-white/10 h-full flex flex-col justify-center">
                  ...
                  <div className="space-y-6">
                    <div>
                      <CountUp end={15} suffix="+" className="text-4xl font-bold text-[#D9FF00] mb-1 block" />
                      <div className="text-sm text-zinc-400 font-medium">Years in ICT and digital systems</div>
                    </div>
                    <div>
                      <CountUp end={10} suffix="+" className="text-4xl font-bold text-[#D9FF00] mb-1 block" />
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                        <i className={`ph-fill ${skill.icon} text-[#D9FF00] text-xl shrink-0`}></i>
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-3">
                        <i className="ph-fill ph-check-circle text-[#D9FF00] text-lg shrink-0 mt-0.5"></i>
            ...
            <div className="mt-6 fade-in-section">
              <div className="bento-card bg-gradient-to-br from-[#D9FF00]/10 via-zinc-900/80 to-zinc-900/50 backdrop-blur-md rounded-3xl p-8 border border-[#D9FF00]/20 flex flex-col justify-center items-start relative overflow-hidden shadow-[0_0_40px_rgba(217,255,0,0.05)]">
                <i className="ph-fill ph-quotes text-4xl text-[#D9FF00]/20 absolute top-6 right-6"></i>
                <h3 className="text-lg md:text-xl font-display font-bold text-white mb-4 relative z-10 leading-relaxed">
                  "I build systems, train people, and use technology to expand impact."
                </h3>
                <div className="w-8 h-1 bg-[#D9FF00]/50 rounded-full mb-3 relative z-10"></div>
                <p className="text-[#D9FF00] font-medium text-xs tracking-wider uppercase relative z-10">Oluwatobi Victor Bilau</p>
              </div>
            </div>
          </div>
        </div>
