export default function ICTExpertise() {
  return (
    <section id="ict-expertise" className="py-24 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#D9FF00]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/3"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 fade-in-section">
          ...
          <p className="text-[#D9FF00] font-medium tracking-wide uppercase text-sm mb-6">Technology Solutions & Digital Systems</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="fade-in-section" style={{ transitionDelay: `${i * 100}ms` }}>
              <div className="bento-card bg-zinc-900/50 backdrop-blur-sm rounded-3xl p-8 border border-white/10 h-full hover:border-[#D9FF00]/30 transition-colors group">
                <div className="w-12 h-12 rounded-xl bg-[#D9FF00]/10 flex items-center justify-center mb-6 group-hover:bg-[#D9FF00]/20 transition-colors">
                  <i className={`ph-fill ${item.icon} text-2xl text-[#D9FF00]`}></i>
                </div>
