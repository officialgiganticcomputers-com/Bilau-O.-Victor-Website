      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 relative fade-in-section">
            ...
            <div className="relative flex flex-col gap-6">
              ...
              <div className="bg-zinc-900 p-6 rounded-2xl shadow-xl border border-zinc-800 flex gap-5 items-start transform -translate-x-4 hover:-translate-x-6 transition-transform">
                <div className="w-14 h-14 bg-amber-500/10 text-amber-400 rounded-xl flex items-center justify-center flex-shrink-0 border border-amber-500/20">
                  <i className="ph-fill ph-church text-2xl"></i>
                </div>
                <div>
                  <h4 className="font-display font-bold text-white text-lg">CAC Latter Rain Centre</h4>
                  <p className="text-xs font-semibold text-amber-400 uppercase tracking-wide mb-2">Media Operations Lead</p>
          ...
          <div className="order-1 lg:order-2 fade-in-section">
            ...
            <h2 className="text-4xl md:text-5xl font-display font-bold text-zinc-900 mb-8 tracking-tight leading-[1.1]">Driving Digital-First Strategy Across Africa</h2>
