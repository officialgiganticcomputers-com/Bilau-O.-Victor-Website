      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-16 items-center fade-in-section">
          ...
          <div className="lg:col-span-5">
            <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-[#D9FF00]/10 text-[#D9FF00] text-xs font-bold uppercase tracking-widest mb-6">Social Impact</div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-zinc-900 mb-6 tracking-tight">The Pedagogy of Empowerment</h2>
            ...
            <div className="bg-zinc-950 rounded-3xl p-8 text-white relative overflow-hidden border border-zinc-800 shadow-2xl">
              <div className="absolute right-0 top-0 w-32 h-32 bg-[#D9FF00]/20 blur-[50px] rounded-full"></div>
              <CountUp end={40} suffix="K+" className="text-6xl font-display font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-[#D9FF00] to-[#D9FF00] mb-2 block" />
          ...
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-6">
            <div className="bento-card p-6 rounded-2xl border border-zinc-200 bg-white hover:bg-zinc-50">
              <div className="w-10 h-10 rounded-lg bg-[#D9FF00]/10 text-[#D9FF00] flex items-center justify-center mb-4">
