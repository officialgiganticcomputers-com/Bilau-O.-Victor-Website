    ...
    <section id="music" className="py-32 bg-zinc-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-[40px] shadow-glass border border-zinc-200/60 p-10 lg:p-16 relative overflow-hidden">
          <div className="absolute -right-32 -top-32 w-96 h-96 bg-[#D9FF00] rounded-full blur-[80px] opacity-60"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            <div className="fade-in-section">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-zinc-900 mb-6 tracking-tight leading-[1.1]">Music as a Vehicle for Transformation</h2>
              ...
              <div className="border-l-2 border-[#D9FF00] pl-6 py-2 my-8">
            ...
            <div className="fade-in-section flex justify-center">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-tr from-[#D9FF00]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
                
                <div className="flex justify-between items-center mb-8 relative z-10">
                  <div className="text-white font-display font-bold text-xl">"Gigantic"</div>
                  <i className="ph-fill ph-music-notes text-3xl text-zinc-600 group-hover:text-[#D9FF00]/50 transition-colors"></i>
                </div>

                <div className="flex items-center justify-center py-8 relative z-10">
                  <div className="relative w-32 h-32 rounded-full border border-zinc-800 flex items-center justify-center bg-zinc-900 shadow-glow group-hover:border-[#D9FF00]/30 transition-colors duration-500">
                    {/* Play Button Overlay */}
                    <div className="absolute inset-0 flex items-center justify-center z-20">
                      <div className="w-16 h-16 bg-[#D9FF00] rounded-full flex items-center justify-center text-zinc-950 shadow-[0_0_20px_rgba(245,158,11,0.4)] group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(245,158,11,0.6)] transition-all duration-300">
                        <i className="ph-fill ph-play text-2xl ml-1"></i>
                      </div>
                    </div>
                    
                    <div className="absolute inset-0 rounded-full border border-[#D9FF00]/30 animate-[spin_4s_linear_infinite]">
                      <div className="absolute -top-1.5 left-1/2 w-3 h-3 bg-[#D9FF00] rounded-full shadow-[0_0_10px_#f59e0b]"></div>
                    </div>
                  </div>
                </div>

                <div className="flex items-end justify-between h-12 gap-1 mt-6 px-4 relative z-10">
                  <div className="w-full bg-[#D9FF00] rounded-t-sm animate-[pulse_1s_ease-in-out_infinite] h-[40%] group-hover:h-[60%] transition-all duration-300"></div>
                  <div className="w-full bg-[#D9FF00] rounded-t-sm animate-[pulse_1.2s_ease-in-out_infinite] h-[80%] group-hover:h-[100%] transition-all duration-300"></div>
                  <div className="w-full bg-[#D9FF00] rounded-t-sm animate-[pulse_0.8s_ease-in-out_infinite] h-[60%] group-hover:h-[40%] transition-all duration-300"></div>
                  <div className="w-full bg-[#D9FF00] rounded-t-sm animate-[pulse_1.5s_ease-in-out_infinite] h-[100%] group-hover:h-[80%] transition-all duration-300"></div>
                  <div className="w-full bg-[#D9FF00] rounded-t-sm animate-[pulse_1.1s_ease-in-out_infinite] h-[50%] group-hover:h-[90%] transition-all duration-300"></div>
                  <div className="w-full bg-[#D9FF00] rounded-t-sm animate-[pulse_0.9s_ease-in-out_infinite] h-[75%] group-hover:h-[50%] transition-all duration-300"></div>
                  <div className="w-full bg-zinc-800 group-hover:bg-[#D9FF00]/50 rounded-t-sm h-[30%] group-hover:h-[70%] transition-all duration-300"></div>
                  <div className="w-full bg-zinc-800 group-hover:bg-[#D9FF00]/50 rounded-t-sm h-[40%] group-hover:h-[60%] transition-all duration-300"></div>
                </div>
              </div>
            </div>
          </div>
