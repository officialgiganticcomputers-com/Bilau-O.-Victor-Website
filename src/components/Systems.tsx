export default function Systems() {
  return (
    <section id="systems" className="py-32 bg-zinc-950 text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-64 bg-amber-500/20 blur-[100px] rounded-full pointer-events-none"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20 fade-in-section">
          <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20 text-xs font-bold uppercase tracking-widest mb-4">Core Infrastructure</div>
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 tracking-tight">The vMix Revolution in Nigerian Liturgy</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 p-10 rounded-3xl fade-in-section hover:bg-zinc-900 transition-colors group">
            <div className="w-14 h-14 bg-zinc-800 rounded-2xl flex items-center justify-center border border-white/5 mb-8 group-hover:border-amber-500/50 transition-colors shadow-glow">
              <i className="ph ph-broadcast text-2xl text-amber-400"></i>
            </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                <i className="ph-fill ph-check-circle text-amber-500"></i> NDI (Network Device Interface)
              </li>
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                <i className="ph-fill ph-check-circle text-amber-500"></i> Multiple HD Camera Inputs
              </li>
            </ul>
          </div>
          ...
          <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 p-10 rounded-3xl fade-in-section hover:bg-zinc-900 transition-colors group">
            <div className="w-14 h-14 bg-zinc-800 rounded-2xl flex items-center justify-center border border-white/5 mb-8 group-hover:border-amber-500/50 transition-colors shadow-glow">
              <i className="ph ph-wifi-high text-2xl text-amber-400"></i>
            </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                <i className="ph-fill ph-check-circle text-amber-500"></i> Dynamic Cinematic Storytelling
              </li>
              <li className="flex items-center gap-3 text-sm text-zinc-300">
                <i className="ph-fill ph-check-circle text-amber-500"></i> Unrestricted Logistical Movement
              </li>
            </ul>
          </div>
        </div>
